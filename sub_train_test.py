...
train_period_features = basic_preprocessig("sub_train_tweets")

""""""

def sub_train_test(model,model_name,train_period_features, eval_period_features):
...
sub_train_test(model,model_name,train_period_features, eval_period_features)
